...
router.post('/:id/quote', authorize('super_admin', 'admin', 'procurement'), quoteProcurement);
router.post('/:id/approve', approveProcurement);
router.patch('/:id/status', authorize('super_admin', 'admin', 'procurement'), updateProcurementStatus);
